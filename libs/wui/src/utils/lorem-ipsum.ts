...
/**
 * Returns Lorem Ipsum text with the requested number of words.
 * Stops on whole words and ensures the string ends with a period.
 *
 * @param wordCount - Word count (default: 50)
 *
 * @example
