...
SOURCE_DIR="${SOURCE_DIR:-apps/lab/src}"
FTP_DIR="${FTP_DIR:-/www/next/projects/lab/}"

echo "🚀 Starting FTP upload (lab)..."
...
echo ""
if [ $result -eq 0 ]; then
  echo "✅ lab upload successful."
  exit 0
else
  echo "❌ Error during lab upload (code: $result)"
  exit 1
fi
