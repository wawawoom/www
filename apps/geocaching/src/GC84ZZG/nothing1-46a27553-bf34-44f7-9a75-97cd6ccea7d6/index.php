...
<body>
  ...
  <div id="container">
    ...
    <div id="content">
      ...
      <div id="colCenter">
        ...
        <p><?php echo $NOTHING1; ?></p>

        <div class="man">
          <div><img src="../img/fire.gif" /></div>
          <div><img src="../img/darknut.gif" /></div>
          <div><img src="../img/fire.gif" /></div>
        </div>
  ...
  <img
    src="http://www.wawawoom.fr/geocaching/analytics/analytics.php?url=<?php echo isset($_SERVER['REQUEST_URI']) ? urlencode($_SERVER['REQUEST_URI']) : ''; ?>&amp;name=The%20Legend%20Of%20GC84ZZG%20-%20Nothing-1">
