    ...
    <ModalContext.Provider value={value}>
      ...
      >
        <WuiText as={WuiTextAs.P}>
          My ideal role is at the intersection of design and development, where
          I can contribute to both the strategic creation and the technical
          ...
          <WuiLink>TODO: Check the figma file</WuiLink> I used for my website.
        </WuiText>
        ...
        <WuiText as={WuiTextAs.P}>
          ...
          with Storybook. <WuiLink>TODO: Check the storybook</WuiLink> I used
          for this website.
        </WuiText>

        <WuiText as={WuiTextAs.P}>
          {" "}
          This approach enables teams to work with reliable, reusable, and
          well-tested components, improving development speed and product
          quality. Storybook also serves as a shared reference between
          stakeholders, designers, and developers, making the system
          transparent, accessible, and easy to evolve over time.
        </WuiText>
        ...
        <WuiText as={WuiTextAs.P}>
          ...
          work environment with three days of remote work and two days on-site.
          I am looking for a role with a target compensation of €60,000 gross
